...
| File | Purpose |
|------|---------|
| `project.yaml` | Complete MSNoise configuration â€” importable directly via `msnoise db init --from-yaml` |
...
|------|-----------|---------|----------|
| 2014 | [Lecocq et al., *Seismological Research Letters*](papers/2014_Lecocq_MSNoiseUndervolc/) | YA — Piton de la Fournaise, La RÃ©union |  |
| 2016 | [De Plaen et al., *Geophysical Research Letters*](papers/2016_DePlaen_PitonDeLaFournaise/) | PF — Piton de la Fournaise, La RÃ©union |  |
<!-- PAPERS_END -->
